...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div id="top" class="navbar-inverse navbar-fixed-top" style="background-color: gainsboro; text-align: center" runat="server">
    ...
    <div id="colore" class="Tutto" runat="server" style="background-color:transparent">
        ...
        <div id="Basso" class="Basso" runat="server">
            ...
            <asp:Label ID="Label3" runat="server" Text="Cassa: " Font-Size="40"></asp:Label>
                ...
                <asp:Label ID="LabelMessaggio" runat="server" Text="" Font-Size="46" Style="white-space: normal" BackColor="Yellow"></asp:Label>
